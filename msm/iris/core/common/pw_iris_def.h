...
do {	\
	...
	(dst)->h_back_porch = (src)->h_back_porch; \
	(dst)->h_sync_width = (src)->h_sync_width; \
	(dst)->h_front_porch = (src)->h_front_porch; \
	(dst)->v_active = (src)->v_active;	\
	(dst)->v_back_porch = (src)->v_back_porch; \
	(dst)->v_sync_width = (src)->v_sync_width; \
	(dst)->v_front_porch = (src)->v_front_porch; \
